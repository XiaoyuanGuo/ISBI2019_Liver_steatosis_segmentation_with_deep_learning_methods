...
def compute_backbone_shapes(config, image_shape):
    ...
    assert config.BACKBONE in ["resnet50", "resnet101","resnet30","resnet65"]
    return np.array(
...
def resnet_graph(input_image, architecture, stage5=False, train_bn=True):
    """Build a ResNet graph.
        ...
        train_bn: Boolean. Train or freeze Batch Norm layres
    """
    assert architecture in ["resnet50", "resnet101","resnet30","resnet65"]
    # Stage 1
    ...
    block_count = {"resnet50": 5, "resnet101":22, "resnet65": 10, "resnet30":2}[architecture]
...
def mrcnn_mask_loss_graph(target_masks, target_class_ids, pred_masks):
    ...
    #print("**************************")
    #focal_loss = K.cast(K.less(diff, 1.0), "float32")
    #focal_loss = 0.25* K.pow(K.cast(K.less(K.abs(y_true-y_pred),1.0), "float32"),2)*K.log( K.abs(y_true-y_pred))
    #print("focal_loss is {}".format(focal_loss))
...
class MaskRCNN():
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        print ('checkpoint_dir: {}'.format(self.checkpoint_path))
        callbacks = [
